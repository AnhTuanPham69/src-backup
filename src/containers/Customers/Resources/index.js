  ...
  return id && progressId ? (
    <ResourcesWrapper>
      <div className="header-section">
        ...
        >
          <Option value="document">{i18next.t('customers.document')}</Option>
          <Option value="startupUpload">{i18next.t('customers.startupUpload')}</Option>
        </Select>
      </div>
      <Tabs activeKey={tabKey || 'document'}>
        <TabPane tab={i18next.t('customers.document')} key="document">
          <ConfigProvider
            renderEmpty={() => (
              <Empty
                description={
          ...
          >
            <List
              ...
              noCardWrapper
              defaultOptions={{
                customApiResource: `startup-progresses/${progressId}/resources`,
              }}
              xScroll={800}
            >
              <RestFieldItem
        ...
        <TabPane tab={i18next.t('customers.startupUpload')} key="startupUpload">
          <ConfigProvider
            renderEmpty={() => (
              <Empty
                description={
