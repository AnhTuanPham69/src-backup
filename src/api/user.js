...
export async function updateCurrentUserApi(data) {
  return put(`/users/${localStorage.getItem('userId')}`, data);
}
...
export async function changePasswordApi(data) {
  return put('/users/me/changePassword', data);
}

export const refreshTokenApi = data => post('/auth/refreshToken', data);

export const updateLocaleApi = data => put('/users/me/update-locale', data);