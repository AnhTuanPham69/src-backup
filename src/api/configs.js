...
export async function getSummariesApi(data) {
  return get('/dashboards', data);
}
...
export const getProgramSummaryApi = () => get('/dashboards/program');

export const getStartUpSummaryApi = () => get('/dashboards/start-up');

export const getUserReportApi = data => get('/dashboards/userReport', data);

export const getStartUpReportApi = data => get('/dashboards/startupReport', data);