...
export const getSearch = (filterData) => {
  const params = {
    limit: filterData.limit,
    offset: filterData.offset,
    q: filterData.q,
    orderBy: filterData.orderBy,
    ...getValidData(filterData.outerFilter),
    ...getValidData(filterData.filter),
  };
...
export const getIdByUrl = (props, location) => {
  ...
  const idFromHash =
    ...
    location.hash.match(`#${props.resource}/(.*)/show`) ||
